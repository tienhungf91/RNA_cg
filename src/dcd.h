...
////////////////////////////////////////////////////////////////////////
int write_timestep (void *v, const double *box,
...
//  unitcell[1] = unitcell[3] = unitcell[5] = 90.0f;
  ...
  for (i=0; i<dcd->natoms; i++) {
    dcd->x[i] = (float) coord_vel_force_struct.coordx [i+1];
    dcd->y[i] = (float) coord_vel_force_struct.coordy [i+1];
    dcd->z[i] = (float) coord_vel_force_struct.coordz [i+1];
  }
  dcd->nsets++;
...
/////////////////////////////////////////////////////////
int read_next_timestep (void *v, int natoms, float *unitcell) {
